					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/?r=article/index">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-12 col-sm-3">
												<input id="form-field-1"  placeholder=" nav name " class="col-xs-10 col-sm-12" type="text" name="news_short_title">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-12 col-sm-3">
												<input id="form-field-1"  placeholder=" nav name " class="col-xs-10 col-sm-12" type="text" name="news_title">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="col-xs-12 col-sm-3">
												<input id="form-field-1"  placeholder=" nav name " class="col-xs-10 col-sm-12" type="text" name="news_addmen">
